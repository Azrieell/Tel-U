...
<body>
    <div class="login-dark">
        <form method="post">
            ...
            <div class="gambar">
              <center><<img src="{{asset("images/logo-journey.png")}}" alt="" srcset="" style=" margin-bottom: 50px; width:100px;"></center>
            </div>
            ...
            <div class="form-group">
                <a  href="/beranda" class="btn btn-primary btn-block" type="submit">Log In</a></div></form>
    </div>
