    ...
    <tr>
        ...
        <td rowspan="5">
            <div class="card rounded shadow" style="margin-left: 10%;">
                <div class="card-body">
                    <h3><b>Skill, Achievements & Other Experience</b></h3>
                    <br>
                    <h4 style="color: gray">Add skills and achievements relevant to the job that you apply.</h4>
    ...
    <tr>
        <td style="height: 30px;">
            ...
            <a href="/resume-builder-education">
                <div class="icon icon-shape  rounded-circle shadow text-center border" style="background-color: red;">
                    <i class="bi bi-person-lines-fill" style="font-size: 15px; color: white;"></i>
                </div>
            </a>
        </td>
    </tr>
    <tr>
        <td style="height: 30px;">
            ...
            <a href="/resume-builder-organisational">
                <div class="icon icon-shape  rounded-circle shadow text-center" style="background-color: red;">
                    <i class="bi bi-person-rolodex" style="font-size: 15px; color: white;"></i>
                </div>
            </a>
        </td>
    </tr>
    <tr>
        <td style="height: 30px;">
            ...
            <a href="/resume-builder-skil">
                <div class="icon icon-shape  rounded-circle shadow text-center" style="background-color: red;">
                    <i class="bi bi-bag-plus" style="font-size: 15px; color: white;"></i>
                </div>
            </a>
        </td>
    </tr>
